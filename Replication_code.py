#CONVERGENCE THROUGH INFERENCE VER 5.65 (5.6Rectangular Share with hardmax and Bayesian updating, entropy &cosine similarity, lowval, flat priors)
...
phi2=0#learning rate in Reinforcement learning for agent 2; same value used for both kinds of update
